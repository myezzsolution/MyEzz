                ...
                <div className="p-8">
                    {!result ? (
                        <div className="space-y-8">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                {[
                                    ...
                                    { id: 'Non-Jain', label: 'Non-Jain', icon: '🍲' },
                                    ...
                                    <button
                                        ...
                                        className={`py-4 rounded-[1.5rem] border-2 transition-all duration-300 flex flex-col items-center gap-1 ${
                        ...
                        <div className="text-center py-2 animate-in slide-in-from-bottom-10 duration-500">
                            <div className="inline-block p-4 rounded-full bg-orange-100 dark:bg-orange-500/20 text-orange-500 text-4xl mb-6 ring-8 ring-orange-50 dark:ring-orange-500/5">
                                🥣
                            </div>
