...
const OrderSuccess = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-400 via-orange-500 to-red-500 p-6">
      <div className="max-w-lg mx-auto bg-[hsl(var(--card))] text-[hsl(var(--card-foreground))] rounded-2xl shadow-2xl p-6 border border-gray-200">
        ...
        <div className="mb-4 text-center bg-orange-50 rounded-lg py-3 shadow-inner">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100">Order ID: #{order.orderId}</h2>
          <p className="text-sm text-gray-500 dark:text-gray-400">Placed on: {new Date(order.orderDate).toLocaleString()}</p>
        </div>

        {/* Customer Details */}
        <div className="mb-6">
          <h3 className="font-bold text-gray-800 dark:text-gray-100 mb-2 border-b pb-1">👤 Customer</h3>
        ...
        {/* Ordered Items */}
        <div className="mb-6">
          <h3 className="font-bold text-gray-800 dark:text-gray-100 mb-2 border-b pb-1">🛒 Items</h3>
        ...
        <p className="text-sm text-gray-600 dark:text-gray-300 mb-6">Payment: <b>{order.paymentMethod.toUpperCase()}</b></p>
